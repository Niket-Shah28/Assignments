...
import com.aurionpro.usersPanel.PanelAdmin;
import com.aurionpro.usersPanel.PanelCustomer;
import com.aurionpro.usersPanel.PanelRestaurantManager;
...
public class FoodDeliveryAppTest {
	...
	public static void loadStubs() {
        ...
        FoodItemsManager.addFoodItem(new FoodItem("Pasta Alfredo", "Creamy pasta with white sauce", FoodCategory.ITALIAN, "Pasta, Cream, Cheese, Garlic"));
        FoodItemsManager.addFoodItem(new FoodItem("Bruschetta", "Toasted bread with tomato topping", FoodCategory.ITALIAN, "Bread, Tomato, Basil, Olive Oil"));
        FoodItemsManager.addFoodItem(new FoodItem("Lasagna", "Layered pasta with meat and cheese", FoodCategory.ITALIAN, "Pasta Sheets, Meat, Cheese, Tomato Sauce"));
        FoodItemsManager.addFoodItem(new FoodItem("Risotto", "Creamy Italian rice dish", FoodCategory.ITALIAN, "Arborio Rice, Parmesan, Butter, Stock"));
        FoodItemsManager.addFoodItem(new FoodItem("Spring Rolls", "Crispy rolls with vegetable filling", FoodCategory.CHINESE, "Cabbage, Carrot, Wrapper, Soy Sauce"));
        FoodItemsManager.addFoodItem(new FoodItem("Sweet and Sour Chicken", "Chicken in tangy sauce", FoodCategory.CHINESE, "Chicken, Pineapple, Bell Pepper, Vinegar"));
        FoodItemsManager.addFoodItem(new FoodItem("Schezwan Fried Rice", "Spicy fried rice with vegetables", FoodCategory.CHINESE, "Rice, Chili Sauce, Vegetables, Garlic"));
        FoodItemsManager.addFoodItem(new FoodItem("Dim Sum", "Steamed dumplings with filling", FoodCategory.CHINESE, "Flour, Meat/Vegetables, Soy Sauce"));
